...
from .. import SocketBoostArchive
from . import MyriaRelation, MyriaQuery, MyriaSchema, utility

class MyriaSocketBinary(SocketBoostArchive):
  type = MyriaRelation
  ...
  def import_(cls, source, intermediate, *args, **kwargs):
    ...
    plan = utility.get_plan(schema, work, MyriaRelation._get_qualified_name(source.name), scan_type='SciDBOpaqueScan')
